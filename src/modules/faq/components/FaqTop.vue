      ...
      items: [
        {
          ...
          content:
            "На странице обращений нажмите на кнопку 'создать обращение'. После заполните всю необходимую информацию и нажать на кнопку создать обращение. В скором времени обращение отобразиться на сайте",
          isExpand: false,
          computedHeight: 0,
        },
        {
